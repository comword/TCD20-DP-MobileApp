...
class ExamResponse PROTOBUF_FINAL :
 ...
 public:
  ...
  enum : int {
    kPendingExamsFieldNumber = 1,
    kFinishedExamsFieldNumber = 2,
  };
  ...
  int finishedexams_size() const;
  private:
  int _internal_finishedexams_size() const;
  public:
  void clear_finishedexams();
  ::student::ExamDetail* mutable_finishedexams(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::student::ExamDetail >*
      mutable_finishedexams();
  private:
  const ::student::ExamDetail& _internal_finishedexams(int index) const;
  ::student::ExamDetail* _internal_add_finishedexams();
  public:
  const ::student::ExamDetail& finishedexams(int index) const;
  ::student::ExamDetail* add_finishedexams();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::student::ExamDetail >&
      finishedexams() const;
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::student::ExamDetail > finishedexams_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  friend struct ::TableStruct_student_2eproto;
};
// -------------------------------------------------------------------
...
// repeated .student.ExamDetail finishedExams = 2;
inline int ExamResponse::_internal_finishedexams_size() const {
  return finishedexams_.size();
}
inline int ExamResponse::finishedexams_size() const {
  return _internal_finishedexams_size();
}
inline void ExamResponse::clear_finishedexams() {
  finishedexams_.Clear();
}
inline ::student::ExamDetail* ExamResponse::mutable_finishedexams(int index) {
  // @@protoc_insertion_point(field_mutable:student.ExamResponse.finishedExams)
  return finishedexams_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::student::ExamDetail >*
ExamResponse::mutable_finishedexams() {
  // @@protoc_insertion_point(field_mutable_list:student.ExamResponse.finishedExams)
  return &finishedexams_;
}
inline const ::student::ExamDetail& ExamResponse::_internal_finishedexams(int index) const {
  return finishedexams_.Get(index);
}
inline const ::student::ExamDetail& ExamResponse::finishedexams(int index) const {
  // @@protoc_insertion_point(field_get:student.ExamResponse.finishedExams)
  return _internal_finishedexams(index);
}
inline ::student::ExamDetail* ExamResponse::_internal_add_finishedexams() {
  return finishedexams_.Add();
}
inline ::student::ExamDetail* ExamResponse::add_finishedexams() {
  // @@protoc_insertion_point(field_add:student.ExamResponse.finishedExams)
  return _internal_add_finishedexams();
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::student::ExamDetail >&
ExamResponse::finishedexams() const {
  // @@protoc_insertion_point(field_list:student.ExamResponse.finishedExams)
  return finishedexams_;
}
